...
- **Tests de integración** (tarea #009):
  - Suite CLI (17 tests): create, list, move, show, delete, metadata de tareas
  - Suite GitService (18 tests): checkout, createBranch, merge, abort, verify, ensureBranch
  - Script npm: `test:integration` ejecuta ambos archivos
  - Cada suite crea entorno aislado en `.test-*-integration/` con cleanup automático
